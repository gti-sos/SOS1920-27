module.exports = function (app) {
	...
	//Proxy Juanlu
    app.use(proxyJuanlu1, function(req, res){
        var url = urlProxyJuanlu1 + req.baseUrl + req.url;
	...
	app.use(proxyJuanlu4, function(req, res){
		...
		var proxyJuanlu5 = "/v1/units"
		var urlProxyJuanlu5 = "https://age-of-empires-2-api.herokuapp.com/api"
