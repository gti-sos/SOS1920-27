...
-  **APIs**:
    ...
    - [https://sos1920-27.herokuapp.com/api/v1/my-awesom-resource-1/docs](https://sos1920-27-jmp.herokuapp.com/) (developed by [José Manuel Pérez Álvarez](https://github.com/JMPere))

- **URLs (al inicio están vacías, se debe usar /loadInitialData)**:
